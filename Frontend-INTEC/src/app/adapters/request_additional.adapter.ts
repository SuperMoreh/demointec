...
export class RequestAdditionalAdapterService {
  ...
  constructor() {
    ...
    this.myApiUrl = 'api/solicitudesDetalleAdicional/';
  }
  ...
  syncToFirebase(): Observable<any> {
    return this.http.post(this.myAppUrl + 'api/sincronizar-solicitudesDetalleAdicional', {});
  }
